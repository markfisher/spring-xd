...
public abstract class AbstractChannelRegistryTests {
	...
	public void testSendAndReceivePubSub() throws Exception {
		...
		registry.deleteInboundPubSub("tap:baz.http", module3InputChannel);
		...
		registry.deleteInboundPubSub("tap:baz.http", module2InputChannel);
		// Clean up as StreamPlugin would
		registry.deleteInbound("baz.0");
		registry.deleteOutbound("baz.0");
		registry.deleteOutboundPubSub("tap:baz.http", tapChannel);
