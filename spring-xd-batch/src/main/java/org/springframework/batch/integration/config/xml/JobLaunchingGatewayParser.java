...
/**
 * The parser for the Job-Launching Gateway, which will instantiate a {@link JobLaunchingGatewayParser}. If no
 * {@link JobLauncher} reference has been provided, this parse will use the use the globally registered bean
 * 'jobLauncher'.
 * 
